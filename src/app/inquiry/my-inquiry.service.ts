...
export class MyInquiryService {

  private myRadiologyByPatientId = this.globals.globallink + 'myinquiry/create';
  private saveInquiry = this.globals.globallink + 'myinquiry/create';
  private myRadiologyList = this.globals.globallink + 'myinquiry/radiology-list/?';
  private myRadiologyListByPatient = this.globals.globallink + 'myinquiry/myRadiologyListByPatient/';
  private myRadiologyListById = this.globals.globallink + 'myinquiry/radiology-listById/';
  private getPatientId = this.globals.globallink + 'mst_patient/getPatientIdByUserId/';
  private sendToOtherss = this.globals.globallink + 'myinquiry/sendToOthers/';
