...
@Component({
  selector: 'app-fileuploadforefferal',
  templateUrl: './fileuploadforefferal.page.html',
  styleUrls: ['./fileuploadforefferal.page.scss'],
})
export class FileuploadforefferalPage implements OnInit {
  appId;
  image_path;
  docOriginalName;
  currentFile;
