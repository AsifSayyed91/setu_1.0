...
@Component({
  selector: 'app-fileuploadformyradiology',
  templateUrl: './fileuploadformyradiology.page.html',
  styleUrls: ['./fileuploadformyradiology.page.scss'],
})
export class FileuploadformyradiologyPage implements OnInit {
  appId;
  image_path;
  docOriginalName;
  currentFile;
