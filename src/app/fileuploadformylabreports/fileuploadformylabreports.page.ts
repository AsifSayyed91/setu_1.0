...
@Component({
  selector: 'app-fileuploadformylabreports',
  templateUrl: './fileuploadformylabreports.page.html',
  styleUrls: ['./fileuploadformylabreports.page.scss'],
})
export class FileuploadformylabreportsPage implements OnInit {
  appId;
  image_path;
  docOriginalName;
  currentFile;
